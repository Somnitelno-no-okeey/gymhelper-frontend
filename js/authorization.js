...
tl.to(welcomeWrapper, {duration: 1.4, ease: "power2.inOut", left: "0%"})
...
.to(authorizationWrapper, {duration: 1.4, ease: "power2.inOut", left: "50%"}, "-=1.4")

const textStage = {
    'register': 'Пожалуйста, войдите в систему, указав свои персональные данные',
    'enter': 'Введите свои персональные данные и начните тренироваться с нами',
};
